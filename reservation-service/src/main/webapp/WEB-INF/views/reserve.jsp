...
<body>
  <div id="container" data-id="${id}" data-userid="${user.id}">
          ...
          <div class="ct_wrap">
              ...
              <div class="section_store_details">
                  <div class="store_details">
                      ...
                      <p class="dsc">
                        장소 : {{placeName}}<br>
                        기간 : {{displayStartDate}}~{{displayEndDate}}
                      </p>
                      <h3 class="in_tit">관람시간</h3>
                      <p class="dsc">{{observationTime}}</p>
              ...
              <div class="section_booking_ticket">
                  <div class="ticket_body">
                      ...
                      <div class="qty" data-type="{{priceType}}">
                        ...
                        <div class="qty_info_icon"> <strong class="product_amount"> <span>{{type}}</span> </strong> <strong class="product_price"> <span class="price">{{price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc"><span class="discounted-price">{{discountedPrice}}</span>원 ({{discountPercentage}}% 할인가)</em> </div>
                      </div>
                      </script>
                  </div>
              </div>
              <div class="section_booking_form">
                          ...
                          <form class="form_horizontal">
                              ...
                              <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                  <div class="inline_control">
                                      <p class="inline_txt selected"><span class="display_time"></span>, 총 <span class="total_cnt">0</span>매</p>
                                  </div>
                              </div>
                          </form>
                      </div>
                  ...
                  <div class="section_booking_agreement">
                      <div class="agreement all">
                        <input type="checkbox" id="chk3" class="chk_agree"><label for="chk3" class="label chk_txt_label"> <span>이용자 약관 전체동의</span> </label>
              ...
              <div class="box_bk_btn">
                  ...
                  <div class="bk_btn_wrap disable"> <button type="button" class="bk_btn" disabled> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
              </div>
          </div>
      </div>
  </div>
